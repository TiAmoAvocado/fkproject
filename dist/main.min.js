function setCookie(e,o,t){var i=new Date;i.setDate(i.getDate()+t),document.cookie=e+"="+o+";expires="+i}function getCookie(e){for(var o=document.cookie.split("; "),t=0;t<o.length;t++){var i=o[t].split("=");if(i[0]==e)return JSON.parse(i[1])}return""}function removeCookie(e){setCookie(e,"",-1)}
...
window.onload=function(){var o=document.getElementById("txt"),a=document.getElementById("pwd");document.getElementsByClassName("lg")[0].onclick=function(){for(var e=getCookie("uname"),n=!1,t=0;t<e.length;t++)if(e[t].pid==o.value&&e[t].pwd==a.value){n=!0;break}n?alert("登陆成功"):alert("登陆失败")};var l=document.getElementById("s1");o.onblur=function(){for(var e=getCookie("uname"),n=!0,t=0;t<e.length;t++)if(e[t].pid==o.value){n=!(l.innerHTML="√");break}n&&(l.innerHTML="用户名不存在，请去注册")}};
window.onload=function(){var l=document.getElementById("txt"),o=document.getElementById("s3"),i=null;l.onblur=function(){for(var e=this.value,n=getCookie("uname"),t=!0,u=0;u<n.length;u++)if(n[u].pid==l.value){t=!1,alert("用户已注册");break}t&&(i=/\1(3|5|7|8)\d{9}$/.test(e)?(o.innerHTML="√",!0):!(o.innerHTML="用户不正确"))};var n=null,e=document.getElementById("txt1"),t=document.getElementById("s4");e.onblur=function(){var e=this.value;n=/^\w{6,6}$/.test(e)?(t.innerHTML="√",!0):!(t.innerHTML="验证码错误")};var u=document.getElementById("pwd"),a=document.getElementById("s1"),c=null;u.onblur=function(){var e=this.value;c=/^\w{6,}$/.test(e)?(a.innerHTML="✔",!0):!(a.innerHTML="用户密码不能少于6位数")};var r=document.getElementById("surepwd"),d=document.getElementById("s2"),m=null;r.onblur=function(){var e=this.value;m=e==u.value&&""!=e?(d.innerHTML="√",!0):!(d.innerHTML="两次密码不一致")};var s=null;if($("input[type='checkbox']").click(function(){var e=$("input[type='checkbox']").prop("checked");s=e?($(".zc").css("background","red"),!0):($(".zc").css("background","#9a9a9a"),!1)}),getCookie("uname"))var v=getCookie("uname");else v=[];document.getElementsByClassName("zc")[0].onclick=function(){if(s&&i&&n&&c&&m){var e={pid:l.value,pwd:u.value};v.push(e),setCookie("uname",JSON.stringify(v))}}};